...
import { useGetMistakePostLazyQuery } from '../../apollo/graphql';
...
export const Mistake: NextPage = () => {
  const { isOpen, onOpen, onClose } = useDisclosure();

  const [getMistake, { loading, data }] = useGetMistakePostLazyQuery();
