...
import { useGetMediumDogPostLazyQuery } from '../../apollo/graphql';
...
export const Medium: NextPage = () => {
  const { isOpen, onOpen, onClose } = useDisclosure();

  const [getMedium, { loading, data }] = useGetMediumDogPostLazyQuery();
        ...
        <Box p={4} textAlign="center" w="1200px" mx="auto">
          ...
          <Box>
            <Flex py={10} justifyContent="center" alignItems="center" fontSize="3xl" fontWeight={700}>
              <Icon as={GiSittingDog} mr={4} />
              <Text>中型犬(25kg未満)</Text>
            </Flex>
            {!loading && data ? (
              data.posts.length === 0 ? (
                <Alert
