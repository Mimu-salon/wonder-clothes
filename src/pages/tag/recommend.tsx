...
import { useGetRecommendPostLazyQuery } from '../../apollo/graphql';
...
export const Recommend: NextPage = () => {
  const { isOpen, onOpen, onClose } = useDisclosure();

  const [getRecommend, { loading, data }] = useGetRecommendPostLazyQuery();
